...
I started my career as a web developer about **{new Date().getFullYear() - 20} years ago**. I've tried some programming languages and tech stack, both Back-End, and Front-End.
...
Working on data science **from 2022 to present ({new Date().getFullYear() - 2018} years)**.
