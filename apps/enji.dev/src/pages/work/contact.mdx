...
| Contact  | Detail                     |
| -------- | -------------------------- |
| Address  | Akurdi, Maharashtra, India |
| Timezone | GMT+5.5                    |
| E-mail   | kuteabhishek2004@gmail.com |
...
If you want to find me on social media, just search for **@abhishekkute**. That's my username on almost all platforms, so it should be easy to find me.

But if you're short on time, I've included some links to the social media platforms I use most frequently below.

| Social Media | Profile URL                                     |
| ------------ | ----------------------------------------------- |
| LinkedIn     | https://linkedin.com/in/abhishek-kute-a85822257 |
| Github       | https://github.com/Abhishekkute234              |
| YouTube      | https://www.youtube.com/@keep_it_sorted         |
